...
//        self.quad = quad ?? EditScanViewController.defaultQuad(forImage: image)
        self.quad = quad ?? EditScanViewController.cpQuad(forImage: image)
    ...
    private static func cpQuad(forImage image: UIImage) -> Quadrilateral {
        
        let circleRad: CGFloat = 80.0
        let topLeft = CGPoint(x: circleRad, y: circleRad)
        let topRight = CGPoint(x: image.size.width - circleRad, y: circleRad)
        let bottomRight = CGPoint(x: image.size.width - circleRad , y: image.size.height - circleRad)
        let bottomLeft = CGPoint(x: circleRad, y: image.size.height - circleRad)
