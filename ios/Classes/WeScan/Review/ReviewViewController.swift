...
final class ReviewViewController: UIViewController {
    ...
    lazy private var doneButton: UIBarButtonItem = {
        ...
        let title = NSLocalizedString("wescan.review.done", tableName: nil, bundle: Bundle(for: ReviewViewController.self), value: "Done", comment: "The done button of the ReviewController")
