...
extension UIImage {
    ...
    func detectOrientationAndFixData() -> UIImage{
        print("CALCULATED HEIGHT: ",self.size.height)
        print("CALCULATED WIDTH: ",self.size.width)
        ...
        {
            return self.rotated(by: Measurement(value: 90.0, unit: .degrees))!
        }
    }
